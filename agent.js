(function () {
    const BASE = 'https://sudhamshkalakonda.github.io/kaze/sprites/';
    const STATES = {
      walk:   { file: 'Walk.png',     frames: 8,  fps: 10, w: 1024, h: 128 },
      run:    { file: 'Run.png',      frames: 8,  fps: 16, w: 1024, h: 128 },
      idle:   { file: 'Idle.png',     frames: 6,  fps: 8,  w: 768,  h: 128 },
      jump:   { file: 'Jump.png',     frames: 12, fps: 12, w: 1536, h: 128 },
      attack: { file: 'Attack_1.png', frames: 6,  fps: 10, w: 768,  h: 128 },
      hurt:   { file: 'Hurt.png',     frames: 2,  fps: 8,  w: 256,  h: 128 },
    };
    ...
    function walkLoop() {
      ...
      if (!open) {
        ...
        if (isJumping && currentState === 'jump') {
          ...
          shadow.style.width = Math.max(20, 50 - jumpY * 0.5) + 'px';
    ...
    function openChatNow() {
      ...
      const left = Math.min(pos, window.innerWidth - 320);
